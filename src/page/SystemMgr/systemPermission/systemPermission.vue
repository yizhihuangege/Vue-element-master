  ...
  <section>
    ...
    <el-main>
      <el-row type="flex" justify="start">
        ...
        <el-col :span="4">
            <el-button @click="openEditor" type="primary" icon="el-icon-plus">添加权限</el-button>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      this.$http.get(`${process.env.GUESSING_HOST_URL}/api/admin/permission`,{ params })
        .then(resp => {
...
const tableHeader = [
  { prop: "id", label: "id" },
  { prop: "title", label: "权限名称" },
  {prop:"urls",label:"权限路由"},
