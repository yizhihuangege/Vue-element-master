<template>
    <section>
        <el-form :form="form" label-width="100px" :rules="rules" :ref="form" :model="form">
            ...
            <el-form-item label="启动页图标" prop="url">
  ...
  methods: {
    ...
    ok(form) {
      this.$refs[form].validate(valid => {
        if (valid) {
          let url = `${process.env.GUESSING_HOST_URL}/api/admin/create_loading`,
            str = "添加",
            params = {
          ...
          if (this.type === "edit") {
            ...
            url = `${process.env.GUESSING_HOST_URL}/api/admin/edit_loading`;
            str = "编辑";
          }
